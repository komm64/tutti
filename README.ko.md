...
🔒 [개인정보 처리방침](https://tutti.komm64.com/privacy.html)
...
질문, 버그 신고, 기능 요청: **[tutti.komm64.com/support.html](https://tutti.komm64.com/support.html)**

또는 **contact@komm64.com**으로 이메일.

## 개인정보

게시 텍스트, 이미지, 동영상은 **귀하의 브라우저 내부에서 완전히** 처리됩니다 — 어떠한 제3자 서버로도 전송되지 않습니다. 자세한 내용은 [개인정보 처리방침](https://tutti.komm64.com/privacy.html)을 참조하세요.
