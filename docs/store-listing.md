...
### v0.4.81 update — English (post-verify / auto-open / per-SNS resize / vertical letterbox を含む現行版)
...
Source code: https://github.com/komm64/tutti
Privacy policy: https://komm64.github.io/tutti/
Support: https://komm64.github.io/tutti/support
```
...
ソースコード: https://github.com/komm64/tutti
プライバシーポリシー: https://komm64.github.io/tutti/
サポート: https://komm64.github.io/tutti/support
```
