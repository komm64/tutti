...
🔒 [隐私政策](https://komm64.github.io/tutti/)
...
问题、bug 报告、功能请求: **[komm64.github.io/tutti/support.html](https://komm64.github.io/tutti/support.html)**

或发邮件至 **contact@komm64.com**。

## 隐私

发布的文本、图片和视频**完全在您的浏览器内**处理 — 绝不发送至任何第三方服务器。详情请参阅[隐私政策](https://komm64.github.io/tutti/)。
