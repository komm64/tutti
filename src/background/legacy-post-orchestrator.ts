...
export type LegacyPostOrchestratorOptions = PostingOrchestratorDependencies;
 ...
 *
 * Keep the complete side-effect workflow intact as the production recovery
 * path while v0.5.50's decomposed orchestrator proves itself. Cross-cutting
 * request safety remains outside this boundary in PostRequestHandler.
 */
export function createLegacyPostOrchestrator(
  options: LegacyPostOrchestratorOptions,
) {
